...
class Test(unittest.TestCase):
    ...
    def _verifiy_fixtures(self,test_case):
        self.assertTrue( filecmp.cmp(os.path.join(self.stage_dir,'.project'), os.path.join(os.path.dirname(os.path.abspath(__file__)),"fixtures/fixture.%s.project_dat" % test_case)) , ".project file not as expected")
        self.assertTrue( filecmp.cmp(os.path.join(self.stage_dir,'.pydevproject'), os.path.join(os.path.dirname(os.path.abspath(__file__)),"fixtures/fixture.%s.pydevproject_dat" % test_case)) , ".pydevproject file not as expected")
